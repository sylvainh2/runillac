            ...
            <footer className="container-fluid">
                <nav className="row col-md-12">
                    <ul className="footerul">
                        <li className="footerli"><a className="footera" target="_blanck" href="https://www.facebook.com/groups/1219553618160337/"><img src={`${process.env.PUBLIC_URL}/img/facebook.png`} alt="facebook" className="imgFB"/></a></li>
                        <div className="foot">
                        ...
                        <li className="footerli"><Link to="/" className="footera"><img className="logo" src={`${process.env.PUBLIC_URL}/img/ASI-logo-01b.png`} alt="logo"/> </Link> </li>
                    </ul>
                </nav> 
            </footer>
        </>
